...
<body>
  ...
  <div class="top-bar">
    ...
    <span class="top-air-quality" id="topAirQuality" style="margin-left:12px; color:#ccc; font-size:0.9rem; display:inline-flex; align-items:center; gap:8px;">
      <span id="aqiValue">—</span>
      <img id="aqiWeatherIcon" src="" alt="" style="display:none; width:20px; height:20px;">
      <span id="aqiWeatherText">—</span>
    </span>
  ...
  <script src="js/air-pollution.js"></script>
</body>
