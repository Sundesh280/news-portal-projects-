...
document.addEventListener('DOMContentLoaded', function() {
  if (DB.getSession()) { window.location.href='index.php'; return; }
  ...
  function doRegister() {
    ...
    if (!name||!email||!password||!pass2) { showMsg(msgEl,'Please fill in all fields.','error'); return; }
    if (password!==pass2) { showMsg(msgEl,'Passwords do not match.','error'); return; }
